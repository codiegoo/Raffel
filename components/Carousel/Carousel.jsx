    ...
    <div id="carouselExampleInterval" className="carousel slide mt-5" data-bs-ride="carousel">
      <div className="carousel-inner">
        <div className="carousel-item active" data-bs-interval="4000">
          <Image priority={true} width={1920} height={1080} src="/images/rifa.jpg" className="d-block w-100" style={{ width: "auto", height: 'auto', objectFit: 'contain' }} alt="First slide iphone 15 pro max 256gb sorteos jp" />
        </div>
        <div className="carousel-item" data-bs-interval="4000">
          <Image priority={true} width={1920} height={1080} src="/images/rifa1.jpg" className="d-block w-100" style={{ width: "auto", height: 'auto', objectFit: 'contain' }} alt="Second slide iphone 15 pro max 256gb sorteos jp" />
        </div>
        {/* <div className="carousel-item" data-bs-interval="4000">
